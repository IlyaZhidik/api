...
export const players = (app: Application) => {
  ...
  app.service(playersPath).hooks({
    ...
    before: {
      all: [
        schemaHooks.validateQuery(playersQueryValidator),
        schemaHooks.resolveQuery(playersQueryResolver),
      ],
      find: [],
      get: [],
      create: [
        schemaHooks.validateData(playersDataValidator),
        schemaHooks.resolveData(playersDataResolver),
      ],
      patch: [
        schemaHooks.validateData(playersPatchValidator),
        schemaHooks.resolveData(playersPatchResolver),
      ],
      remove: [],
    },
    after: {
